...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://sosi.medblogers-base.ru',
    'http://sosi.medblogers-base.ru',
...
LIMIT_SPECIALITY_ON_SEARCH = 5
LIMIT_CITY_ON_SEARCH = 5
...
S3_FREELANCERS_BUCKET_NAME = os.getenv('S3_FREELANCERS_BUCKET_NAME')
...
S3_FREELANSERS_CLIENT = S3Client(
    bucket_name=S3_FREELANCERS_BUCKET_NAME,
    access_key=S3_AWS_ACCESS_KEY_ID,
    secret_key=S3_AWS_SECRET_ACCESS_KEY,
    region=S3_REGION_NAME,
    endpoint_url=S3_ENDPOINT,
